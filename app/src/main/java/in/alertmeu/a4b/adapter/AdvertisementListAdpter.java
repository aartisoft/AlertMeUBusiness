...
public class AdvertisementListAdpter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    class MyHolder extends RecyclerView.ViewHolder {
        ...
        TextView title, description, numbers, txtExpire, txtNotStarted, totalViews, totalRedeemed, txtValidity, mainCat, subCat, txtCancelled, txtDeleted, totalpaid, txtActive, barCodeCat, limitation, txtDeactivated;
